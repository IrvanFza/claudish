# Devin dynamic models catalog fixture
...
It is the fixture for `providers/model-resolvers/devin.ts`, whose entire job is to fold this dynamic
models catalog into the rows a human picks and unfold a selection back into a wire id. Both
directions are only meaningful against a real dynamic models catalog: the resolver's rules exist
because of properties this file has and a hand-written fixture would not —
...
for: a dynamic models catalog shape nobody anticipated.
