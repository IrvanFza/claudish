...
- `headless-vs-interactive.md` — `-p` is not interactive-minus-a-TTY; `--agent` validation is
  silently skipped under `--input-format stream-json` (upstream: closed as not planned); why magmux
