...
export const MODEL_CARDS: ModelCard[] = [
  {
    ...
    provider: "Google",
    description: "2M Context. The new standard for long-context reasoning.",
  ...
  },
  {
    ...
    provider: "Kimi",
    description: "Extended reasoning with exceptional context handling.",
    tags: ["THINKING", "CONTEXT", "TOOLS"],
    color: "bg-purple-600",
  },
  {
    id: "m4",
